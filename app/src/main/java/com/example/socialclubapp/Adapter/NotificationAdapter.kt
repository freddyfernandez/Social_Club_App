package com.example.socialclubapp.Adapter
...
import com.example.socialclubapp.Fragments.PostDetailsFragment
import com.example.socialclubapp.Fragments.ProfileFragment
import com.example.socialclubapp.Model.Notification
import com.example.socialclubapp.Model.Post
import com.example.socialclubapp.Model.User
import com.example.socialclubapp.R
    ...
    : RecyclerView.Adapter<NotificationAdapter.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        if (notification.getText().equals("empezo a seguirte"))
        {
            holder.text.text = "empezo a seguirte"
        }
        else if (notification.getText().equals("le gustó tu publicación"))
        {
            holder.text.text = "le gustó tu publicación"
        }
        else if (notification.getText().contains("comento:"))
        {
            holder.text.text = notification.getText().replace("comento:", "comento: ")
        }
        else
        {

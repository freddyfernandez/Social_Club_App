...
import com.example.socialclubapp.AddStoryActivity
import com.example.socialclubapp.Model.Story
import com.example.socialclubapp.Model.User
import com.example.socialclubapp.R
import com.example.socialclubapp.StoryActivity
            ...
            override fun onDataChange(p0: DataSnapshot)
            {
                ...
                if (click)
                {
                    if (counter>0)
                    {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Agregar Historia")
                        {
                                dialogInterface, which ->
                ...
                else
                {
                    if (counter>0)
                    {
                        textView.text = "Mi historia"
                        imageView.visibility = View.GONE
                    }
                    else
                    {
                        textView.text = "Agregar Historia"

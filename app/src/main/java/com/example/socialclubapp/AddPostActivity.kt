...
class AddPostActivity : AppCompatActivity()
{
    ...
    {
        when{
            imageUri == null -> Toast.makeText(this, "Porfavor selecione primero la imagen.", Toast.LENGTH_LONG).show()
            TextUtils.isEmpty(description_post.text.toString()) -> Toast.makeText(this, "Por favor escriba la descripción.", Toast.LENGTH_LONG).show()
                ...
                progressDialog.setMessage("Por favor espere, estamos agregando su publicación de imagen...")
                progressDialog.show()
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                    ...
                    if (task.isSuccessful)
                    {
                        ...
                        Toast.makeText(this, "Post cargado correctamente.", Toast.LENGTH_LONG).show()

package com.example.socialclubapp.Fragments
...
import com.example.socialclubapp.AccountSettingsActivity
import com.example.socialclubapp.Adapter.MyImagesAdapter
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        {
            view.edit_account_settings_btn.text = "Editar Perfil"
        }
        ...
        view.edit_account_settings_btn.setOnClickListener {
            ...
            when
            {
                getButtonText == "Editar Perfil" -> startActivity(Intent(context, AccountSettingsActivity::class.java))

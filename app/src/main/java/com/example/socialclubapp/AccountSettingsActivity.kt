...
import com.example.socialclubapp.Model.User
...
class AccountSettingsActivity : AppCompatActivity()
{
    ...
    {
        when {
            TextUtils.isEmpty(full_name_profile_frag.text.toString()) -> Toast.makeText(this, "Por favor escriba el nombre completo primero.", Toast.LENGTH_LONG).show()
            username_profile_frag.text.toString() == "" -> Toast.makeText(this, "Por favor escriba el nombre de usuario primero.", Toast.LENGTH_LONG).show()
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this, "Por favor escribe tu biografía primero.", Toast.LENGTH_LONG).show()
            else -> {
    ...
    private fun uploadImageAndUpdateInfo()
    {
        when
        {
            imageUri == null -> Toast.makeText(this, "Por favor seleccione la imagen primero.", Toast.LENGTH_LONG).show()
            TextUtils.isEmpty(full_name_profile_frag.text.toString()) -> Toast.makeText(this, "Por favor escriba el nombre completo primero.", Toast.LENGTH_LONG).show()
            username_profile_frag.text.toString() == "" -> Toast.makeText(this, "Por favor escriba el nombre de usuario primero.", Toast.LENGTH_LONG).show()
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this, "Por favor escribe tu biografía primero.", Toast.LENGTH_LONG).show()
                ...
                progressDialog.setTitle("Configuraciones de la cuenta")
                progressDialog.setMessage("Por favor espere, estamos actualizando su perfil...")
                progressDialog.show()
